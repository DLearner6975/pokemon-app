...
export const PokemonTitle = ({ width, height }: SVGProps<SVGSVGElement>) => {
  return (
    <svg
    ...
    >
      ...
      />
      <path id="path94" className="st12" d="M115.7 47.5z" />
      <path
        id="path96"
        className="st13"
      ...
      <path id="polygon172" className="st16" d="M162.8 35.4l-6.2 6 5.9 5.3z" />
      <path
        id="path174"
        className="st17"
